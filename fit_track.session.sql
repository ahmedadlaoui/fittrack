...
VALUES (1, 1, 'Focus on strength training and cardio.'),
    (
        2,
        2,
        'Yoga exercises for flexibility and strength.'
    ),
    (
        3,
        3,
        'Marketing strategies and team management.'
    ),
...
VALUES ('2024-12-10', '10:00:00', 1, 1),
...
SELECT d.department_name,
    COUNT(t.trainer_ID) AS nombre_entraineurs
FROM departments d
...
SELECT r.room_number,
    r.room_type,
    COUNT(m.membership_ID) AS total_abonnements
FROM rooms r
...
-- @block
SELECT Gender, COUNT(*) AS number_of_members
FROM members
GROUP BY Gender
HAVING COUNT(*) >= 2;
